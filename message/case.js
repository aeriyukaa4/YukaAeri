...
var Ownerin ="6289513081052@s.whatsapp.net"
...
_prem.addPremiumUser(nomernya, waktunya, premium)
let teks =`
Success
...
case 'rules':{
	...
	conn.sendButImage(from, teks, `© DryanBOT`, fs.readFileSync('./stik/bot.jpg'), mok, {quoted: dev})             
	}
	break
...
const configuration = new Configuration({
  apiKey: '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',
});
